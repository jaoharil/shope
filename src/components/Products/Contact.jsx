  ...
  return (
    <div className="container mt-5">
      <div class="flex items-center justify-center">
        <div class="flex flex-col justify-center items-center bg-gray-800 text-white rounded-lg shadow-lg p-6 w-80">
          <h2 class="text-2xl font-bold mb-4 text-center">Welcome!</h2>
          <p class="mb-4 text-center">Thanks for visiting our website. Stay connected with us on social media.</p>
          <div class="flex space-x-4">
            <a class="text-blue-500 hover:text-blue-400 transition duration-200" href="#">
            ...
            <a class="text-blue-400 hover:text-blue-300 transition duration-200" href="#">
              <svg viewBox="0 0 64 64" height="60" width="60" y="0px" x="0px" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M30.772,45.786l0.621,1.9c7.123-2.326,12.824-7.914,15.642-15.33l-1.869-0.711 C43.636,35.671,39.733,42.859,30.772,45.786z" fill="url(#iS8U25XJCb2VBQOwbuAcrb_bYzsf9Bmocst_gr2)"></path>
                <g>
                  <linearGradient gradientUnits="userSpaceOnUse" y2="21.528" y1="17.979" x2="42" x1="42" id="iS8U25XJCb2VBQOwbuAcrc_bYzsf9Bmocst_gr3">
                    <stop stop-color="#6dc7ff" offset="0"></stop>
                    <stop stop-color="#e6abff" offset="1"></stop>
                  </linearGradient>
                  <circle fill="url(#iS8U25XJCb2VBQOwbuAcrc_bYzsf9Bmocst_gr3)" r="2" cy="20" cx="42"></circle>
                </g>
              </svg>
            </a>
            <a class="text-blue-400 hover:text-blue-300 transition duration-200" href="#">
              <svg viewBox="0 0 64 64" height="60" width="60" y="0px" x="0px" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M25 39.84L25 24.16 38.44 32z" fill="url(#PMWUiMSnUf2R_PPJ6rqZeb_44112_gr2)"></path>
                ...
                <path d="M24,41.581V22.419L40.425,32L24,41.581z M26,25.901v12.197L36.456,32L26,25.901z" fill="url(#PMWUiMSnUf2R_PPJ6rqZec_44112_gr3)"></path>
              </svg>
            </a>
          </div>

          <button class="bg-gradient-to-r mt-4 from-blue-500 to-pink-500 text-white font-bold py-2 px-4 rounded-full animate-pulse">Close</button>
        </div>
      </div>
    </div>
  );
